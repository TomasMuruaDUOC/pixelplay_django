# Generated by Django 5.2 on 2025-04-14 04:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('accion', 'Acción'), ('aventura', 'Aventura'), ('retro', 'Retro'), ('estrategia', 'Estrategia'), ('deportes', 'Deportes')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('juego', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pixelplay.juego')),
            ],
            options={
